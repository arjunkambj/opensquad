...
const FAILURE_NOTE: Record<typeof vReplyFailureCode.type, string> = {
  ...
  refused:
    "Your agent did not read this reply — the workspace could not run the classification right now (credits, a limit, or a pause). The reply is here and nothing was sent.",
  uncertain:
