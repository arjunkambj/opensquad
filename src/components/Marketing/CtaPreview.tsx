        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-4">
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="truncate text-xs text-muted-foreground">
                      30 min intro call · Outreach
                    </p>
                  </div>
                  <span className="hidden h-5 w-fit shrink-0 items-center justify-center rounded-4xl bg-secondary px-2 py-0.5 text-xs font-medium whitespace-nowrap text-secondary-foreground sm:inline-flex">
                    {slot.note}
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex h-7 items-center gap-1 rounded-2xl bg-primary px-3 pl-2 text-sm font-medium text-primary-foreground">
                <HugeiconsIcon className="size-4" icon={Tick02Icon} />
                Approve and send
              </span>
              <span className="inline-flex h-7 items-center rounded-2xl bg-secondary px-3 text-sm font-medium text-secondary-foreground">
                Edit draft
              </span>
