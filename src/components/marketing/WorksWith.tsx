...
const groups = [
  {
    ...
    items: ["Your website", "300 credits, no card", "Your own inbox"],
  },
  {
    name: "What it does",
...
export function WorksWith() {
  return (
    <div
      className="grid gap-10 md:grid-cols-[1.6fr_1fr] md:gap-0"
      id="works-with"
    >
      {groups.map((group) => (
        <div
          className="flex min-w-0 flex-col gap-5 border-border border-b pb-10 last:border-0 last:pb-0 md:border-r md:border-b-0 md:px-6 md:pb-0 md:first:pl-0 md:last:pr-0 lg:px-8"
          key={group.name}
        >
